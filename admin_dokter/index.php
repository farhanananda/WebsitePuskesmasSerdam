               ...
               <div class="resp-tabs-container">
                  <div class="tab-1 resp-tab-content">
                     <div class="swm-right-w3ls">
                        <form action="<?= $admin_dokter ?>login" method="post">
                           <div class="main">
                  ...
                  <div class="tab-1 resp-tab-content">
                     <div class="swm-left-w3ls">
                        <form action="<?= $admin_dokter ?>register" method="post">
                           <div class="main">
                              <div class="icon-head-wthree">
                                 <h2>Daftar</h2>
                              </div>
                              <div class="form-left-to-w3l">
                                 <input type="text" name="nama_dokter" placeholder="Nama Lengkap Dokter" required="">
                              </div>
								<div class="form-left-to-w3l">
                              ...
                              <div class="form-left-to-w3l">
                                 <input type="text" name="nomorhp" placeholder="Nomor Handphone" required="">
                              </div>
                              <div class="form-left-to-w3l">

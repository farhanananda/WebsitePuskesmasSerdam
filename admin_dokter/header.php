  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-sm-inline-block">
        <b class="nav-link">
        <?
          $dokter = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM dokter WHERE id_user='".userid()."'"));
        ?>
          Antrian Sekarang: <?= kode_poli($dokter['poli']).antrian_sekarang($dokter['poli']) ?>
          (<?= poli($dokter['poli']) ?>)
        </b>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= $admin_dokter ?>logout">Logout</a>
      </li>
    </ul>
  </nav>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= $admin_dokter ?>">Home</a></li>

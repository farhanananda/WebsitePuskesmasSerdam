        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?
                $query = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM dokter WHERE id_dokter = '".stripslashes($_GET['id'])."' "));
              ?>
              ...
              <form role="form" action="<?= $master ?>submit" method="POST">
                ...
                <input type="hidden" name="id_dokter" value="<?= $_GET['id'] ?>">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="dokter_edit">Simpan</button>
                </div>
              </form>
